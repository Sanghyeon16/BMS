...
#            
#            # input place holders
#            self.X = tf.placeholder(tf.float32, [None, seq_length, data_dim], name='X')
...
#Parameters
    ...
    Volt_max = 4.4435        #Maximum Value of Voltage
    Volt_min = 2.9115         #Minimum Value of Voltage
    downSize_div = 1        #Reducing size when OOM error happens.
    
    num_models = 3         #The number of models
...
#Data preprocessing
    ...
    #test_s1 = np.loadtxt('RW25_refdis_13.csv', delimiter=',')
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(iterations):
            ...
            for m_idx in range(num_models):
                ...
                avg_cost_list[m_idx] = (c_1 + c_2 + c_3) / 3 # divide into batch size
                print('cost = ', avg_cost_list)
